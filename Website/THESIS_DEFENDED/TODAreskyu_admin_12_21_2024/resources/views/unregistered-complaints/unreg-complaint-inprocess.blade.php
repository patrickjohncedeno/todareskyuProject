        ...
        <tbody>
            @foreach ($complaints as $complaint)
                <tr class="position-relative" role="button"
                    onclick="window.location='{{ route('complaints.unreg-inprocess-show', $complaint->complaint_unregistered_ID) }}'">
                    ...
                    <td>
                        ...
                        <span class=" translate-middle-y action-icons">
                            <a href="{{ route('complaints.unreg-inprocess-edit', $complaint->complaint_unregistered_ID) }}"
