        ...
        <div class="border-0 d-flex flex-column">
            <div class="container-fluid d-flex justify-content-between align-items-center" style="list-style-type: circle;">
                ...
                <button type="button" class="btn p-0 mb-3 shadow-none border-0 close-button"
                    onclick="window.location.href='{{ route('complaints.unreg-settled') }}'">
        ...
        <div class="row mt-4">
            <div class="col-6">
                ...
                <p class="fs-6 mb-1 "><span class="fw-semibold ">Date Submitted:</span>
                    ...
                    <div class="fs-6 mb-1">
                        <span class="fw-semibold">Payment Receipt:</span>
                    <span>
                    @if ($complaint->paymentReceipt == null)
                            Violation payment receipt has not been uploaded yet.
                            <form
                                action="{{ route('complaints.unreg-addPaymentReceipt', $complaint->complaint_unregistered_ID) }}"
                                method="post" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                <div class="">
                                    <div class="d-flex">
                                        <input type="file" class="form-control form-control-sm" name="paymentReceipt"
                                            id="validID" accept="image/*">
                        ...
                        @else
                            <a href="#" data-bs-toggle="modal" data-bs-target="#imageModal">
                                <img src="{{ asset('storage/' . $complaint->paymentReceipt) }}" alt="Image Preview"
                                ...
                                <div class="modal-dialog modal-lg">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="imageModalLabel">Payment Receipt Preview</h5>
                                            <button type="button" class="btn-close" data-bs-dismiss="modal"
                                                aria-label="Close"></button>
                                        </div>
                                        <div class="modal-body">
                                            <img src="{{ asset('storage/' . $complaint->paymentReceipt) }}"
                                                alt="Large Image Preview" class="img-fluid" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <p class="mb-1"><span class="fw-semibold">Resolution Detail:</span>
                        {{ $complaint->resolutionDetail }}</p>
