    ...
    <div class="bg-white p-3 rounded-4 shadow">
        ...
        <div class="">
            <form id="updateForm" method="POST"
                action="{{ route('complaints.unreg-denied-update', $complaint->complaint_unregistered_ID) }}">
                @csrf
                @method('PUT')
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control rounded shadow-sm" id="controlNo"
                                value="{{ str_pad($complaint->complaint_unregistered_ID, 3, '0', STR_PAD_LEFT) }}">
                        </div>
                ...
                <div class="modal-footer mt-4">
                    <a class="me-2" href="{{ route('complaints.unreg-denied') }}">
