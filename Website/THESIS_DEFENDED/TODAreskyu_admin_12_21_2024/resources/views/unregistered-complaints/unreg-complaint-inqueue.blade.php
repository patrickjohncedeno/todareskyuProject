...
@section('content')
    ...
    <table class="table mb-0 table-hover align-middle">
        ...
        @foreach ($unregComplaints as $complaint)
        <tbody>
            <tr style="cursor: pointer" onclick="window.location.href='{{ route('complaints.unreg-inqueue-show', $complaint->complaint_unregistered_ID) }}'">
                <td class="text-start ps-3">
                    ...
                    <span class="fw-bold">Control No.
                        {{ str_pad($complaint->complaint_unregistered_ID, 3, '0', STR_PAD_LEFT) }}</span>
                </td>
        ...
        <a href="{{ route('complaints.unreg-add') }}">
            ...
            data-bs-toggle="tooltip" data-bs-placement="left" title="Add Unregistered Complaint">
