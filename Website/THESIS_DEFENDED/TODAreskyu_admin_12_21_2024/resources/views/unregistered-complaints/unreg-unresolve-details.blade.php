        ...
        <div class="border-0 d-flex flex-column">
            <div class="container-fluid d-flex justify-content-between align-items-center" style="list-style-type: circle;">
                ...
                <button type="button" class="btn p-0 mb-3 shadow-none border-0 close-button"
                    onclick="window.location.href='{{ route('complaints.unreg-unresolved') }}'">
...
<h5 class="mb-0"></i>Tricycle's Information</h5>
        ...
        <div class="row mt-4">
            ...
            <div class="col-6">
                    ...
                    <p class="fs-6 mb-1"><span class="fw-semibold">Reason for Unresolved Status:</span>
                        {{ $complaint->resolutionDetail }}</p>
                    <p class="fs-6 mb-1"><span class="fw-semibold">Date Resolved:</span>
