    ...
    <div class="bg-white p-3 rounded-4 shadow">
        ...
        <div class="">
            <form id="updateForm" method="POST"
                action="{{ route('complaints.reg-denied-update', $complaint->complaint_registered_ID) }}">
                @csrf
                @method('PUT')
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control rounded shadow-sm" id="controlNo"
                                value="{{ str_pad($complaint->complaint_registered_ID, 3, '0', STR_PAD_LEFT) }}">
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control rounded shadow-sm" id="driver"
                                value="{{ $complaint->driver->driverName }}">
                        </div>
                        ...
                        <div class="col-12">
                            <label for="summary" class="form-label">Reason for Denying</label>
                            <textarea class="form-control rounded shadow-sm" id="summary" rows="4" name="description"
                                style="resize: none;">{{ $complaint->reasonForDenying }}</textarea>
                        </div>
                ...
                <div class="modal-footer mt-4">
                    <a class="me-2" href="{{ route('complaints.reg-denied') }}">
