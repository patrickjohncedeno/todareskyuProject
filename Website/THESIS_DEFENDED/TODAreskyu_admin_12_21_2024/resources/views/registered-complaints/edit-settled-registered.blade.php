    ...
    <div class="bg-white p-3 rounded-4 shadow">
        ...
        <div class="">
            <form id="updateForm" method="POST"
                action="{{ route('complaints.reg-settled-update', $complaint->complaint_registered_ID) }}">
                @csrf
                @method('PUT')
                ...
                <div class="container-fluid">
                    <div class="row g-3">
                        ...
                        <div class="col-12">
                            <label for="summary" class="form-label">Resolution Detail</label>
                            <textarea class="form-control rounded shadow-sm" id="summary" rows="4" name="description"
                ...
                <div class="modal-footer mt-4">
                    <a class="me-2" href="{{ route('complaints.reg-settled') }}">
