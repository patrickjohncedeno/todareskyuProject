   ...
   <table class="table m-0 table-hover rounded-3 align-middle">
    ...
    <thead class="border-dark">
        <tr class=" align-items-center" style="vertical-align:  middle;">
            ...
            <tbody class="fs-6">
                @foreach ($regResolved as $complaint)
                    <tr class="position-relative" role="button" onclick="window.location='{{ route('complaints.reg-settled-details', $complaint->complaint_registered_ID) }}'">
                        <td >{{ str_pad($complaint->complaint_registered_ID, 3, '0', STR_PAD_LEFT) }}</td>
                ...
                <td class="ms-2" style="border-left: none; width: 30px">
                    ...
                    <a href="{{ route('complaints.reg-settled-edit',$complaint->complaint_registered_ID) }}" style="text-decoration: none;">
