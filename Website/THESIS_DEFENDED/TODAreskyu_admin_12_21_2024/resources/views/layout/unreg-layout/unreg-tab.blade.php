...
<body class="container-fluid bg-white-50 bg-light-gray">
    ...
    <div class="p-3" style="margin-left: 21%;">
        <div class="d-flex flex-row align-items-center justify-content-between mb-4">
            ...
            <div class="d-flex">
                {{-- <button type="button" class="position-relative me-5" data-bs-toggle="dropdown" aria-expanded="false"
        ...
        <ul class="nav d-flex nav-fill align-content-start bg-white mb-2 shadow-sm rounded-4 overflow-hidden py-1 border-bottom">
            <li class="nav-item" role="presentation ">
                <a class="nav-link text-black d-flex flex-row flex-fill align-items-center justify-content-center position-relative ps-1 pe-1 {{ request()->is('*colorum/inqueue*') ? 'active' : '' }}" href="{{ route('complaints.unreg-inqueue') }}">
                    <div class="position-relative me-2">
                        @if(request()->is('*colorum/inqueue*'))
            ...
            <li class="nav-item" role="presentation">
                <a class="nav-link text-black d-flex flex-row flex-fill align-items-center justify-content-center position-relative ps-1 {{ request()->is('*colorum/inprocess*') ? 'active' : '' }}" href="{{ route('complaints.unreg-inprocess') }}">
                    <div class="position-relative me-2">
                        @if(request()->is('*colorum/inprocess*'))
                            <!-- Active state with bi-clock-fill icon -->
            ...
            <li class="nav-item" role="presentation">
                <a class="nav-link text-black d-flex flex-row flex-fill align-items-center justify-content-center position-relative ps-1 {{ request()->is('*colorum/settled*') ? 'active' : '' }}" href="{{ route('complaints.unreg-settled') }}">
                    <div class="position-relative me-2">
                        @if(request()->is('*colorum/settled*'))
                            <!-- Active state with bi-clock-fill icon -->
            ...
            <li class="nav-item" role="presentation">
                <a class="nav-link text-black d-flex flex-row flex-fill align-items-center justify-content-center position-relative ps-1 {{ request()->is('*colorum/unresolved*') ? 'active' : '' }}" href="{{ route('complaints.unreg-unresolved') }}">
                    <div class="position-relative me-2">
                        @if(request()->is('*colorum/unresolved*'))
                            <!-- Active state with bi-clock-fill icon -->
                    ...
                    <span class="badge bg-danger p-1 ms-2" style="float: right">@yield('unresolve')</span>
                </a>
            </li>
        
            <li class="nav-item" role="presentation">
                <a class="nav-link text-black d-flex flex-row flex-fill align-items-center justify-content-center position-relative ps-1 {{ request()->is('*colorum/denied*') ? 'active' : '' }}" href="{{ route('complaints.unreg-denied') }}">
                    <div class="position-relative me-2">
                        @if(request()->is('*colorum/denied*'))
                            <!-- Active state with bi-clock-fill icon -->
