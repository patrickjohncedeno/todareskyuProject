...
<body class="container-fluid bg-white-50 bg-light-gray">
    ...
    <div class="bg-dark my-3 p-3 position-fixed rounded-3 bg-gradient-dark shadow-lg" style="width: 20%; height: 94%;">
        <ul class="nav flex-column">
            ...
            <li class="nav-item mb-1">
                <a href="#complaintsMenu" class="mb-1 d-flex flex-row align-items-center ps-3 text-decoration-none text-white w-100 rounded" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="complaintsMenu">
            ...
            <li class="nav-item mb-1 @yield('violation') rounded ">
            ...
            <li class="nav-item mb-1 @yield('tricycle') rounded">
            ...
            <li class="nav-item mb-1 @yield('commuter') rounded">
            ...
            <li class="nav-item mb-1 @yield('announcement') rounded">
    ...
    <div class="p-3" style="margin-left: 21%;">
        <div class="d-flex flex-row align-items-center justify-content-between mb-2">
            ...
            <div>
                <p class="m-0 fs-2 fw-bold">@yield('title_head')</p>
            </div>
